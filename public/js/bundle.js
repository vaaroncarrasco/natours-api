...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); // get alert box
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe'; // * no need to add route for updating user data cause we're using axios to send data as post to specific route for us
...
// file export
var stripe = Stripe('pk_test_51JR3FBDyTKJqXcAHZAl4tVP1DaYu4KIfOLB6RUQleLAE3opzKN8b3h43hhidkMTD2RcCLJMn97LX88ZGryGJUPNX00m3UPGoMn');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // Recreating enctype=multipart/formdata programmaticaly

    var form = new FormData(); // * Web API Web Workers -> new FormData() -> instance{}
    ...
    regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // we use .textContent to change html text content value
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  (0, _stripe.bookTour)(tourId); // from stripe.js which calls the api endpoint w/ axios
});
