...
app.use((req, res, next) => { // middleware runs after someone sends any request method to server, after middleware runs, response is send back to client
    console.log('Hello from middleware');
    next(); // always call next() to keep req/res cycle
});

app.use((req, res, next) => { // we can handle this code in other route handler; like loggin it to console in getAllTours
